...
import type { SubmitMutation } from '@graphql/sbatchServiceClient/generated/createJob.generated';
...
export default function useResolveJobForm(): [
  (type: WorkloadType, details: DetailsData) => Promise<FetchResult<SubmitMutation>>,
  { loading: boolean },
] {
  const [submit, { loading }] = useSubmitMutation();

  return [
    async (type: WorkloadType, details: DetailsData) => {
      let job: Job;
      switch (type) {
