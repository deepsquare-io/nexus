...
exports.todoSchemaAsJsonSchemaWithIdTypeStringOrNumber = exports.todoSchemaAsJsonSchemaWithIdTypeNumber = exports.todoSchemaAsJsonSchemaWithoutNullableArrayItems = exports.todoSchemaAsJsonSchema = exports.getTodoSchemaIntrospection = void 0;
...
exports.todoSchemaAsJsonSchema = generateBaseSchema();
exports.todoSchemaAsJsonSchemaWithoutNullableArrayItems = lodash_1.cloneDeepWith(generateBaseSchema(), (value, key, object, stack) => {
    if (key === 'items' &&
...
exports.todoSchemaAsJsonSchemaWithIdTypeNumber = lodash_1.cloneDeepWith(generateBaseSchema(), (value, key, object, stack) => {
    if (key === 'type' && (object === null || object === void 0 ? void 0 : object.title) === 'ID') {
        return 'number';
    }
});
exports.todoSchemaAsJsonSchemaWithIdTypeStringOrNumber = lodash_1.cloneDeepWith(generateBaseSchema(), (value, key, object, stack) => {
    if (key === 'type' && (object === null || object === void 0 ? void 0 : object.title) === 'ID') {
